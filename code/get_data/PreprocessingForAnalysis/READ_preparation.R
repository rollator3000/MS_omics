...
cancertypeshort <- "READ"
cancertypelong <- "Rectum_Adenocarcinoma_READ"
...
# --> Mutation measurements are from other patients than those
# in the data set.
# --> Do not include mutation data.

comids <- intersect(intersect(intersect(rownames(clin), rownames(mirna)), rownames(cnv)), rownames(rna))
length(comids)
...
save(clin, targetvar, mirna, cnv, rna, file=paste("./Additional_file_2_HornungWright_WITH_DATA_EXECUTABLE_VERSION/Data/ProcessedData/", cancertypeshort, ".Rda", sep=""))
