...
cancertypeshort <- "PCPG"
cancertypelong <- "Pheochromocytoma_and_Paraganglioma_PCPG"
...
# --> There are only censcored patients in this data set.

# --> It cannot be used for analysis.
