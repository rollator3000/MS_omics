...
# block information
block_information <- list(1:29, 30:45, 46:89, 90:171, 172:190)
...
# save the results
saveRDS(results, "../data/results_permute_blocks_small_3_2020_05_28.Rds")
